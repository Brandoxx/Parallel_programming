// Copyright 2019 Jeisson Hidalgo Céspedes
// Con cambios realizados por Gabriel Molina Bulgarelli, 2022
...
size_t array_find_first_private(array_t* array, const void* element,
                                size_t start_pos);
...
array_t* array_create(size_t capacity) {
  ...
  if (array->elements == NULL) return (void)free(array), NULL;
  return array;
}
...
int array_increase_capacity(array_t* array) {
  ...
  void** new_elements = (void**)realloc(array->elements,
