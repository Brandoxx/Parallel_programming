...
/**
 * @brief Now we know who the statistics belong to
 * 
...
void generate_lucky_statistics(int process_number, int process_count) {
  ...
  const double all_average = double(all_sum) / process_count;  // Compute average
  if (my_lucky_number == all_min) {  // I am the process with the minimum lucky number
    std::cout << "Process " << process_number << ": my lucky number ("  // Print message
      << my_lucky_number << ") is the minimum (" << all_min << ")" << std::endl;  // Print message
  }

  if (my_lucky_number < all_average) {  // I am the process with a lucky number below average
    ...
    std::cout << "Process " << process_number << ": my lucky number ("
      ...
      << ")" << std::endl;  // Print message
  } else {  // I am the process with the average lucky number
    std::cout << "Process " << process_number << ": my lucky number ("
  ...
  if (my_lucky_number == all_max) {
    std::cout << "Process " << process_number << ": my lucky number ("
      << my_lucky_number << ") is the maximum (" << all_max << ")" << std::endl;  // Print message
  }
}
